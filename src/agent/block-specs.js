...
export const BLOCK_SPECS = {
    ...
    event_whenkeypressed: {shape: 'hat', fields: {KEY_OPTION: {}}},
    event_whenthisspriteclicked: {shape: 'hat'},
    event_whenstageclicked: {shape: 'hat'},
    event_whenbackdropswitchesto: {shape: 'hat', fields: {BACKDROP: {}}},
    event_whengreaterthan: {shape: 'hat', fields: {WHENGREATERTHANMENU: {}}, args: {VALUE: 'number'}},
    ...
    motion_goto: {args: {TO: {menu: 'motion_goto_menu', field: 'TO', default: '_random_'}}},
    motion_gotoxy: {args: {X: 'number', Y: 'number'}},
    motion_glideto: {args: {SECS: 'number', TO: {menu: 'motion_glideto_menu', field: 'TO', default: '_random_'}}},
    motion_glidesecstoxy: {args: {SECS: 'number', X: 'number', Y: 'number'}},
    motion_pointindirection: {args: {DIRECTION: 'angle'}},
    motion_pointtowards: {args: {TOWARDS: {menu: 'motion_pointtowards_menu', field: 'TOWARDS', default: '_mouse_'}}},
    ...
    looks_switchcostumeto: {args: {COSTUME: {menu: 'looks_costume', field: 'COSTUME', default: ''}}},
    looks_nextcostume: {},
    looks_switchbackdropto: {args: {BACKDROP: {menu: 'looks_backdrops', field: 'BACKDROP', default: ''}}},
    looks_nextbackdrop: {},
    looks_changesizeby: {args: {CHANGE: 'number'}},
    looks_setsizeto: {args: {SIZE: 'number'}},
    looks_changeeffectby: {fields: {EFFECT: {}}, args: {CHANGE: 'number'}},
    looks_seteffectto: {fields: {EFFECT: {}}, args: {VALUE: 'number'}},
    looks_cleargraphiceffects: {},
    looks_show: {},
    looks_hide: {},
    looks_gotofrontback: {fields: {FRONT_BACK: {}}},
    looks_goforwardbackwardlayers: {fields: {FORWARD_BACKWARD: {}}, args: {NUM: 'integer'}},
    looks_costumenumbername: {shape: 'reporter', fields: {NUMBER_NAME: {}}},
    looks_backdropnumbername: {shape: 'reporter', fields: {NUMBER_NAME: {}}},
    looks_size: {shape: 'reporter'},

    // ---- 音 ----
    sound_playuntildone: {args: {SOUND_MENU: {menu: 'sound_sounds_menu', field: 'SOUND_MENU', default: ''}}},
    sound_play: {args: {SOUND_MENU: {menu: 'sound_sounds_menu', field: 'SOUND_MENU', default: ''}}},
    sound_stopallsounds: {},
    sound_changeeffectby: {fields: {EFFECT: {}}, args: {VALUE: 'number'}},
    sound_seteffectto: {fields: {EFFECT: {}}, args: {VALUE: 'number'}},
    sound_cleareffects: {},
    ...
    control_stop: {fields: {STOP_OPTION: {}}, shape: 'cap', mutationStop: true},
    control_start_as_clone: {shape: 'hat'},
    control_create_clone_of: {args: {CLONE_OPTION: {menu: 'control_create_clone_of_menu', field: 'CLONE_OPTION', default: '_myself_'}}},
    control_delete_this_clone: {shape: 'cap'},

    // ---- 調べる ----
    sensing_touchingobject: {shape: 'boolean', args: {TOUCHINGOBJECTMENU: {menu: 'sensing_touchingobjectmenu', field: 'TOUCHINGOBJECTMENU', default: '_mouse_'}}},
    ...
    sensing_distanceto: {shape: 'reporter', args: {DISTANCETOMENU: {menu: 'sensing_distancetomenu', field: 'DISTANCETOMENU', default: '_mouse_'}}},
    sensing_askandwait: {args: {QUESTION: 'string'}},
    sensing_answer: {shape: 'reporter'},
    sensing_keypressed: {shape: 'boolean', args: {KEY_OPTION: {menu: 'sensing_keyoptions', field: 'KEY_OPTION', default: 'space'}}},
    sensing_mousedown: {shape: 'boolean'},
    sensing_mousex: {shape: 'reporter'},
    sensing_mousey: {shape: 'reporter'},
    sensing_setdragmode: {fields: {DRAG_MODE: {}}},
    ...
    operator_mathop: {shape: 'reporter', fields: {OPERATOR: {}}, args: {NUM: 'number'}},
